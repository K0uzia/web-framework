    ...
    public static function render(string $field, string $url, string $accept, string $error = ''): string
    {
        ...
        if ($url !== '') {
            ...
            $preview = '<div class="dev-uploader__preview">'
                ...
                . '<form class="dev-inline-form" method="post" action="/dev/media/' . $safeField . '/remove" data-dev-ajax="media-' . $safeField . '">'
        ...
        return '<div class="dev-uploader" id="uploader-' . $safeField . '">'
            . $preview
            . '<form class="dev-inline-form" method="post" action="/dev/media/' . $safeField . '/upload" enctype="multipart/form-data" data-dev-ajax="media-' . $safeField . '">'
