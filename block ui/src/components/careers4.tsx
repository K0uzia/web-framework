    ...
    <section className={cn("py-32", className)}>
      <div className="container mx-auto">
        ...
        <div className="mt-4 max-w-2xl space-y-4 text-muted-foreground">
          <p>
            Each category lists open roles with explicit locations so candidates
            know whether travel is required before they read the full spec.
          </p>
          <p>
            Click a title to open the detailed posting on your ATS; the arrow on
            the right mirrors that same target for mouse-first users.
          </p>
        </div>
        <div className="mt-10 flex flex-col gap-16 md:mt-14">
