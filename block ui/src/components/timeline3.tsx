        ...
        <div className="relative grid gap-16 md:grid-cols-2">
          <div className="top-40 h-fit md:sticky">
            ...
            <div className="mt-8 flex flex-col gap-4 lg:flex-row">
              <Button className="gap-2" size="lg" render={<a href={buttons.primary.url} />} nativeButton={false}>{buttons.primary.text}</Button>
              <Button variant="outline" size="lg" className="gap-2" render={<a href={buttons.secondary.url} />} nativeButton={false}>{buttons.secondary.text}</Button>
            </div>
          </div>
