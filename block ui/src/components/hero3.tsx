        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
          <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 text-center md:ml-auto lg:order-1 lg:items-start lg:text-left">
            ...
            <div className="flex w-full flex-col justify-center gap-2 sm:flex-row lg:justify-start">
              ...
              {buttons?.secondary && (
                <Button variant="outline" size="lg" className="w-full bg-background sm:w-auto dark:bg-background" render={<a href={buttons.secondary.url} />} nativeButton={false}>{buttons.secondary.text}</Button>
              )}
            </div>
          </div>
