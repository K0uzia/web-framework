          ...
          {items.map((item, index) => (
            <React.Fragment key={index}>
              <div className="grid items-center gap-4 px-4 py-5 md:grid-cols-4">
                ...
                <Button variant="outline" render={<a className="order-3 ml-auto w-fit gap-2 md:order-none" href={item.link} />} nativeButton={false}><span>View project</span><ArrowRight className="h-4 w-4" /></Button>
              </div>
              <Separator />
            </React.Fragment>
          ))}
