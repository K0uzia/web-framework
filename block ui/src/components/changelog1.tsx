          ...
          {entries.map((entry, index) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                {entry.button && (
                  <Button variant="link" className="mt-4 self-end" render={<a href={entry.button.url} target="_blank" />} nativeButton={false}>{entry.button.text}<ArrowUpRight className="h-4 w-4" /></Button>
                )}
              </div>
            </div>
          ))}
