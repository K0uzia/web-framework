...
/**
 * Styles et variantes du bloc Expérience (conversion shadcnblocks experience1).
 */
final class ExperienceStyle
{
    /** @var list<string> */
    ...
    {
        if (in_array($variant, SectionAssets::experienceVariantIds(), true)) {
            return $variant;
        }
