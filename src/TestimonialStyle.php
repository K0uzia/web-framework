...
/**
 * Styles et variantes du bloc Témoignages (conversion shadcnblocks).
 */
final class TestimonialStyle
{
    /** @var list<string> */
    ...
    {
        if (in_array($variant, SectionAssets::testimonialVariantIds(), true)) {
            return $variant;
        }
